...
func TestEncodeRefundBCH(t *testing.T) {
	...
	km, _ := key_manager.NewBCHCoinKeyManager(LOCAL_RPC_HOST_BCH, "regnet", "user", "123", getSigners())
...
func TestTopBlockIdBCH(t *testing.T) {
	client, err := NewBCHCoin(LOCAL_RPC_HOST_BCH, &chaincfg.RegressionNetParams, nil, "user", "123", "", 0.0015, 0.0005, map[string]bool{})
	assert.NoError(t, err)
...
func TestEncodeWithMultipleInputsBCH(t *testing.T) {
	client, err := NewBCHCoin(LOCAL_RPC_HOST_BCH, &chaincfg.RegressionNetParams, getSigners(), "user", "123", "", 0.0015, 0.0005, map[string]bool{})
	assert.NoError(t, err)
...
func TestGenerateMultisigBCH(t *testing.T) {
	client, err := NewBCHCoin(LOCAL_RPC_HOST_BCH, &chaincfg.RegressionNetParams, []string{"03AF8891DA9BBF3CED03F04BC3C17EC4D3AE61D464E9B89A6B6A1FA60E361FDEA4", "038CAFE50CA757FAD36DA592A7C2B19158C0163445BAC2DDF6A59BDDC8F5BF6AD1", "03F8C8D630BB53B2E08FB108E2A951C84E582BB3D585D2127FAE6DE43150A415AE"}, "user", "123", "", 0.0015, 0.0005, map[string]bool{})
	assert.NoError(t, err)
