...
func TestWithdrawalGanacheTX(t *testing.T) {
	...
	network := test.ETHER_NETWORKS[test.ROPSTEN]
	coin, _ := NewEthereumCoin(network.NetworkId, network.Rpc, "c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3", nil, 0.00002, 0.00001, map[string]bool{})
	coin.Attach()
	encoded, _ := coin.EncodeRefund(*w)
	println(encoded)
...
func TestGanacheTX(t *testing.T) {
	...
	coin, err := NewEthereumCoin(network.NetworkId, network.Rpc, "c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3", nil, 0.00002, 0.00001, map[string]bool{})
	if err != nil {
		t.Error(err)
		return
	}
