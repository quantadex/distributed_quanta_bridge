...
func (_TrustContract *TrustContractTransactor) FlushTokens(opts *bind.TransactOpts, tokenContractAddress common.Address) (*types.Transaction, error) {
	return _TrustContract.contract.Transact(opts, "flushTokens", tokenContractAddress)
}

// FlushTokens is a paid mutator transaction binding the contract method 0x3ef13367.
//
// Solidity: function flushTokens(tokenContractAddress address) returns()
func (_TrustContract *TrustContractSession) FlushTokens(tokenContractAddress common.Address) (*types.Transaction, error) {
	return _TrustContract.Contract.FlushTokens(&_TrustContract.TransactOpts, tokenContractAddress)
}

// FlushTokens is a paid mutator transaction binding the contract method 0x3ef13367.
//
// Solidity: function flushTokens(tokenContractAddress address) returns()
func (_TrustContract *TrustContractTransactorSession) FlushTokens(tokenContractAddress common.Address) (*types.Transaction, error) {
	return _TrustContract.Contract.FlushTokens(&_TrustContract.TransactOpts, tokenContractAddress)
}
