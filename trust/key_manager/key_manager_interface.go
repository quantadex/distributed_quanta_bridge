...
func NewBitCoinKeyManager(bitcoinRPC string, network string, rpcUser, rpcPassword string, signers []string) (KeyManager, error) {
	return &BitcoinKeyManager{bitcoinRPC: bitcoinRPC, chaincfg: crypto.GetChainCfgByString(network), rpcUser: rpcUser, rpcPassword: rpcPassword, signers: signers}, nil
}

func NewLiteCoinKeyManager(bitcoinRPC string, network string, rpcUser, rpcPassword string, signers []string) (KeyManager, error) {
	return &LitecoinKeyManager{bitcoinRPC: bitcoinRPC, chaincfg: crypto.GetChainCfgByStringLTC(network), rpcUser: rpcUser, rpcPassword: rpcPassword, signers: signers}, nil
}

func NewBCHCoinKeyManager(bitcoinRPC string, network string, rpcUser, rpcPassword string, signers []string) (KeyManager, error) {
	return &BCHKeyManager{bitcoinRPC: bitcoinRPC, chaincfg: crypto.GetChainCfgByStringBCH(network), rpcUser: rpcUser, rpcPassword: rpcPassword, signers: signers}, nil
}
