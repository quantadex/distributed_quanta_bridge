...
func (r FutureAddMultisigAddressResult) Receive() (*btcjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var addr btcjson.CreateMultiSigResult
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []btcutil.Address, account string) (*btcjson.CreateMultiSigResult, error) {
