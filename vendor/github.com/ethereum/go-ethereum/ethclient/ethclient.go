...
// TransactionByHash returns the transaction with the given hash.
func (ec *Client) TransactionBlockHashByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, blockhash *common.Hash, s string, isPending bool, err error) {
	var json *rpcTransaction
	err = ec.c.CallContext(ctx, &json, "eth_getTransactionByHash", hash)
	if err != nil {
	...
	return json.tx, json.BlockHash, *json.BlockNumber, json.BlockNumber == nil, nil
}
