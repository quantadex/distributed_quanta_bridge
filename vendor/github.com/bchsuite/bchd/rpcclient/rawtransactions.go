...
func (r FutureDecodeScriptResult) Receive() (*bchjson.DecodeScriptResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult bchjson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := bchjson.NewDecodeScriptCmd(scriptHex)
	return c.sendCmd(cmd)
}

func (c *Client) DecodeScript(serializedScript []byte) (*bchjson.DecodeScriptResult, error) {
